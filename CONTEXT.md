...
- `application themes`: theme selection cycles through System, Light Orange, Light Green, Dark Orange, and Dark Purple. Light Orange and Dark Purple preserve the previous light and dark themes; Light Green uses `#228B22` (forest green) as its primary, and Dark Orange uses Light Orange's `#CC785C` primary on the previous dark theme.
